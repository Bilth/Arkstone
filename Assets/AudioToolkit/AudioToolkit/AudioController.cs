...
public class AudioController : SingletonMonoBehaviour<AudioController>, ISerializationCallbackReceiver
{
    ...
    protected AudioObject _PlayMusic( string audioID, Vector3 position, Transform parentObj, float volume, float delay, float startTime )
    {
        ...
        _currentMusic = _PlayAsMusicOrAmbienceSound( audioID, volume, position, parentObj, delay, startTime, false, 0, null, doFadeIn ? 0 : 1 );
    ...
    protected AudioObject _PlayAmbienceSound( string audioID, Vector3 position, Transform parentObj, float volume, float delay, float startTime )
    {
        ...
        _currentAmbienceSound = _PlayAsMusicOrAmbienceSound( audioID, volume, position, parentObj, delay, startTime, false, 0, null, doFadeIn ? 0 : 1 );
    ...
    protected AudioObject _PlayAsMusicOrAmbienceSound( string audioID, float volume, Vector3 worldPosition, Transform parentObj, float delay, float startTime, bool playWithoutAudioObject, double dspTime = 0, AudioObject useExistingAudioObject = null, float startVolumeMultiplier = 1 )
    {
    ...
    protected AudioObject _PlayEx( string audioID, float volume, Vector3 worldPosition, Transform parentObj, float delay, float startTime, bool playWithoutAudioObject, double dspTime = 0, AudioObject useExistingAudioObject = null, bool playAsMusicOrAmbienceSound = false, float startVolumeMultiplier = 1 )
    {
        ...
        return PlayAudioItem( sndItem, volume, worldPosition, parentObj, delay, startTime, playWithoutAudioObject, useExistingAudioObject, dspTime, playAsMusicOrAmbienceSound, startVolumeMultiplier );
    }
    ...
    /// </returns>
    public AudioObject PlayAudioItem( AudioItem sndItem, float volume, Vector3 worldPosition, Transform parentObj = null, float delay = 0, float startTime = 0, bool playWithoutAudioObject = false, AudioObject useExistingAudioObj = null, double dspTime = 0, bool playAsMusicOrAmbienceSound = false, float startVolumeMultiplier = 1 )
    {
        ...
        for ( int index = 0; index < sndSubItems.Length; index++ )
        {
            ...
            if ( sndSubItem != null )
            {
                var audioObjRet = PlayAudioSubItem( sndSubItem, volume, worldPosition, parentObj, delay, startTime, playWithoutAudioObject, useExistingAudioObj, dspTime, playAsMusicOrAmbienceSound, startVolumeMultiplier );
    ...
    /// The created <see cref="AudioObject"/> or <c>null</c>
    /// </returns>
    public AudioObject PlayAudioSubItem( AudioSubItem subItem, float volume, Vector3 worldPosition, Transform parentObj, float delay, float startTime, bool playWithoutAudioObject, AudioObject useExistingAudioObj, double dspTime = 0, bool playAsMusicOrAmbienceSound = false, float startVolumeMultiplier = 1 )
    {
        _ValidateCategories();
