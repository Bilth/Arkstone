Shader "Beautify/Beautify" {
	Properties {
		...
		_OutlineMode ("Outline Mode", Float) = 1.0
...
Subshader {	
  ...
  Pass { // 1
      ...
      #pragma target 3.0
// Edited by Shader Control: #pragma multi_compile __ BEAUTIFY_DALTONIZE BEAUTIFY_SEPIA BEAUTIFY_NIGHT_VISION BEAUTIFY_THERMAL_VISION
#pragma multi_compile __ BEAUTIFY_DALTONIZE 
