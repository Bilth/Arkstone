...
namespace BeautifyEffect {
				...
				public class BeautifyEffectInspector : Editor {
								...
								GUIStyle blackStyle, commentStyle, foldoutBold, foldoutNormal;
								...
								public override void OnInspectorGUI () {
												...
												EditorGUILayout.BeginHorizontal ();
												GUILayout.Label (new GUIContent ("Quality", "The best performance variant is simply less accurate but slightly faster. Can be changed at runtime."), GUILayout.Width (90));
												...
												if (_effect.quality != BEAUTIFY_QUALITY.Basic) {
																...
																if (testFeatureEnabled (isBloomEnabled)) {
																				...
																				if (expandBloomSection) {
																								...
																								GUILayout.Label (new GUIContent ("   Layer Mask", "Select which layers can be used for bloom."), labelStyle, GUILayout.Width (90));
																								...
																								GUILayout.Label (new GUIContent ("   Depth Atten", "Reduces bloom effect on distance."), labelStyle, GUILayout.Width (90));
																								...
																								if (_effect.quality == BEAUTIFY_QUALITY.BestQuality) {
																												...
																												EditorGUILayout.EndHorizontal ();
																												EditorGUILayout.BeginHorizontal ();
																												GUILayout.Label (new GUIContent ("   Blur", "Adds an additional blur pass to smooth bloom."), GUILayout.Width (90));
																...
																if (testFeatureEnabled (isBloomEnabled)) {
																				...
																				if (expandSFSection) {
																								...
																								EditorGUILayout.EndHorizontal ();
																								EditorGUILayout.BeginHorizontal ();
																								GUILayout.Label (new GUIContent ("   Sun", "Assign a Game Object (usually a Directional Light that acts as the Sun) to automatically synchronize the light direction."), GUILayout.Width (90));
																								_effect.sun = (Transform)EditorGUILayout.ObjectField (_effect.sun, typeof(Transform), true);
																								EditorGUILayout.EndHorizontal ();
//							EditorGUILayout.BeginHorizontal ();
//							GUILayout.Label (new GUIContent ("   Flare Texture", "Texture used for the sun flares effect."), GUILayout.Width (90));
...
//							EditorGUILayout.EndHorizontal ();
																...
																if (testFeatureEnabled (isVignettingEnabled)) {
																				...
																				if (expandVignettingSection) {
																								...
																								EditorGUILayout.EndHorizontal ();
																								EditorGUILayout.BeginHorizontal ();
																								GUILayout.Label (new GUIContent ("   Mask Texture", "Texture used for masking vignette effect. Alpha channel will be used to determine which areas remain untouched (1=color untouched, less than 1=vignette effect)"), GUILayout.Width (90));
																...
																if (testFeatureEnabled (isFrameEnabled)) {
																				...
																				if (expandFrameSection) {
																								...
																								EditorGUILayout.EndHorizontal ();
																								EditorGUILayout.BeginHorizontal ();
																								GUILayout.Label (new GUIContent ("   Mask Texture", "Texture used for frame effect."), GUILayout.Width (90));
																...
																GUILayout.Label (new GUIContent ("Outline", "Enables outline (edge detection) effect. Color alpha specifies edge detection threshold (reference values: 0.8 for depth, 0.35 for Sobel)."), labelStyle, GUILayout.Width (90));
																if (testFeatureEnabled (isOutlineEnabled)) {
																				...
																				if (_effect.outline) {
																								EditorGUILayout.EndHorizontal ();
																								EditorGUILayout.BeginHorizontal ();
																								GUILayout.Label (new GUIContent ("   Mode", "Choose the outline algorithm. For 2D graphics, use Sobel."), GUILayout.Width (90));
