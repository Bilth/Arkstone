...
public class Sunsetting : MonoBehaviour
{
    ...
    public Sunsetting(float pTimeOfDay, string pColorSun, string pColorShadow, string pColorSky)
    {
        Init(pTimeOfDay, pColorSun, pColorShadow, pColorSky, 0.00002f);
    }

    public Sunsetting(float pTimeOfDay, string pColorSun, string pColorShadow, string pColorSky, float pFogDensity)
    {
