...
{
    public static SystemSky instance;
    ...
    void Start()
    {
        ...
        _defs = new List<DataSky>();

        // Sunlight, Shadow, Sky / Fog
        _defs.Add(new DataSky(2f, "FFC07AFF", "720101", "FF676700")); // Warm Sunset
        _defs.Add(new DataSky(2f, "14253BFF", "171A29", "1C2232", 0.00001f)); // Twilight
        _defs.Add(new DataSky(2f, "FEFFB0FF", "2A96A6", "FEFFB0FF")); // Spring Morning
        _defs.Add(new DataSky(2f, "2D76D9FF", "171A29", "1C51B8FF", 0.00001f)); // Twilight
        _defs.Add(new DataSky(2f, "FF6D0DFF", "981294", "975CC800")); // Soft Heat
        _defs.Add(new DataSky(2f, "FF6D0DFF", "981294", "975CC800")); // Soft Heat
