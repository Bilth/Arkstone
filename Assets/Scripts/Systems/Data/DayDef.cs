...
public class DayDef : MonoBehaviour
{
    ...
    public DayDef(float pTimeOfDay, string pColorSun, string pColorShadow, string pColorSky)
    {
        Init(pTimeOfDay, pColorSun, pColorShadow, pColorSky, 0.00002f);
    }

    public DayDef(float pTimeOfDay, string pColorSun, string pColorShadow, string pColorSky, float pFogDensity)
    {
