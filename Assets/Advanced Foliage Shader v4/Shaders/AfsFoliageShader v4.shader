	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputAFSSpecular o) {
			...
			clip(o.Alpha - _Cutoff);
				...
				o.Smoothness = 0;// trngls.b; // REMOVE SMOOTHING. LOOKS LIKE GARBAGE PLASTIC
				o.Specular = _SpecularReflectivity;
				o.Normal = UnpackNormalDXT5nm(trngls);
				//o.Translucency = trngls.r; //REMOVED TO FIX WEIRD BACKLIGHTING
